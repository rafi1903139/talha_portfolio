...
class Experience(models.Model):
    ...
    def __str__(self):
        return f"{self.job_position} at {self.organization_info}"
...
class Training(models.Model):
    ...
    subsection = models.ForeignKey(TrainingSubSection, on_delete=models.CASCADE,null=True, blank=True)
...
class ExpertiseItem(models.Model):
    area_of_expertise = models.ForeignKey(AreaOfExpertise, on_delete=models.CASCADE, related_name='expertise_items')
...
class SoftwareName(models.Model):
    software_skill = models.ForeignKey(SoftwareSkill, on_delete=models.CASCADE, related_name='software_names')
    name = models.CharField(max_length=200)
